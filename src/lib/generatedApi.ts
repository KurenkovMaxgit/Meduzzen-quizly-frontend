import { quizlyApi as api } from './quizlyApi';
...
const injectedRtkApi = api.injectEndpoints({
  endpoints: (build) => ({
    ...
    companyControllerFindAll: build.query<
      CompanyControllerFindAllApiResponse,
      CompanyControllerFindAllApiArg
    >({
      query: (queryArg) => ({
    ...
    companyControllerFindOneById: build.query<
      CompanyControllerFindOneByIdApiResponse,
      CompanyControllerFindOneByIdApiArg
    >({
      query: (queryArg) => ({
...
export type CompanyControllerFindAllApiResponse = unknown;
